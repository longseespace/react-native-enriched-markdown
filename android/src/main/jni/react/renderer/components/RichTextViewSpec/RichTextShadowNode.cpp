...
extern const char RichTextComponentName[] = "RichTextView";

void RichTextShadowNode::setMeasurementsManager(
    const std::shared_ptr<RichTextMeasurementManager> &measurementsManager) {
  ensureUnsealed();
...
// recalculate layout.
void RichTextShadowNode::dirtyLayoutIfNeeded() {
...
Size RichTextShadowNode::measureContent(const LayoutContext &layoutContext,
