...
Size RichTextMeasurementManager::measure(SurfaceId surfaceId, int viewTag, const RichTextViewProps &props,
  ...
  local_ref<JString> componentName = make_jstring("RichTextView");
